INSERT INTO clinics (id, name, address, telephone, email, pasword, image)
VALUES (1, 'Vancouver Veterinary Clinic', '547 Vet street', '543-432-3211', 'contact@vancouvervetclinic.com', '#RR4tr54ff34$#r', 'path/to/image'),
...
INTERT INTO clinic_pet_types (id, clinic_id, pet_type_id)
VALUES (1, 1, 1),
VALUES (2, 1, 2),
VALUES (3, 1, 3),
VALUES (4, 1, 4),
...
INSERT INTO patients (id first_name, last_name, telephone, email, pasword)
VALUES (1, 'Danyl', 'Walton', '323-543-7873', 'danylwalton@gmail.com', '@$45gfrf4#gf'),
...
INSERT INTO pets (id, type_id, owner_id, name, age, gender, breed, weight, info, image)
VALUES (3, 1, 2, 'Oliver', 3, 'Male', 'Parrot', 6, 'Perfectly healthy long haired cat.', 'path/to/image'),
...
INSERT INTO appointments (id, clinic_id, pet_id, date)
VALUES (1, 1, 3, '10/01/2020'),
VALUES (2, 3, 3, '10/02/2020'),
VALUES (3, 4, 3, '10/03/2020'),
VALUES (4, 2, 3, '10/01/2020'),
VALUES (5, 4, 3, '10/02/2020'),
VALUES (6, 2, 3, '10/03/2020'),
;