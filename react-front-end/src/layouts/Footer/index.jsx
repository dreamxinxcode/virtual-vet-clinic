      ...
      <div id="footer-container">
        <a href="https://www.lighthouselabs.ca/" target="_blank">
          <svg
            ...
            viewBox="0 0 357 93.5"
          >
            <g id="Layer_1">
              <g>
                <path
                  fill="#DA5251"
                  d="M227.4,80.9v-2.2h23.4v2.2H227.4z"
                ></path>
              </g>
              <g>
                <defs>
                  <polygon
                    id="SVGID_1_"
                    points="225.7,21.9 210.7,15.1 210.7,12.7 228.6,20.9 228.6,23 210.7,31.1 210.7,28.7 225.7,21.9 			"
                  ></polygon>
                </defs>
                <use
                  xlinkHref="#SVGID_1_"
              ...
              <path
                fill="#012D3D"
                d="M249.2,78.7l-2.9-50.1h1.3v-1.8h-2.3v-8.7h2.8l-9.1-8.5l-8.5,8.5h2.4v8.7h-2.4v1.8h1.6L229,78.7H249.2z
            ...
            <g id="Layer_2">
              <g>
                <path
                  fill="#012D3D"
                  d="M3.6,74.2V47.8h2.8v24h13.5v2.5H3.6z"
                ></path>
                <path fill="#012D3D" d="M24.9,74.2V47.8h2.8v26.5H24.9z"></path>
                <path
                  fill="#012D3D"
                  d="M50.6,71.4c-0.9,1-1.9,1.7-3.2,2.2c-1.2,0.5-2.5,0.8-3.8,0.8c-2.7,0-4.8-0.7-6.2-2.2
                ...
                <path
                  fill="#012D3D"
                  d="M74.7,74.2V62.1H62.1v12.1h-2.8V47.8h2.8v11.8h12.6V47.8h2.8v26.5H74.7z"
                ></path>
                <path
                  fill="#012D3D"
                  d="M92.9,50.3v24h-2.8v-24h-7.6v-2.5h18.1v2.5H92.9z"
                ></path>
                <path
                  fill="#012D3D"
                  d="M120.9,74.2V62.1h-12.6v12.1h-2.8V47.8h2.8v11.8h12.6V47.8h2.8v26.5H120.9z"
                ></path>
                <path
                  fill="#012D3D"
                  d="M146.4,71.7c-1.8,1.8-4.1,2.7-6.8,2.7c-2.7,0-4.8-0.7-6.2-2.2s-2.4-2.9-2.6-4.3c-0.3-1.4-0.4-3.7-0.4-6.9
                ...
                <path
                  fill="#012D3D"
                  d="M164.3,74.4c-2.7,0-4.9-0.8-6.6-2.5c-1.7-1.7-2.6-3.8-2.6-6.4V47.8h2.8v17.5c0,2,0.6,3.6,1.7,4.8
                ...
                <path
                  fill="#012D3D"
                  d="M187.6,74.4c-2,0-3.7-0.3-5.1-0.8s-2.7-1.4-4-2.7l1.9-1.9c1.1,1.1,2.1,1.8,3.2,2.2c1.1,0.4,2.4,0.7,4,0.7
                ...
                <path
                  fill="#012D3D"
                  d="M202.7,74.2V47.8h16.4v2.5h-13.6v9.3h11.6v2.5h-11.6v9.6h13.6v2.5H202.7z"
                ></path>
              </g>
              <g>
                <path
                  fill="#012D3D"
                  d="M259.3,74.4V47.9h2.8v24h13.5v2.5H259.3z"
                ></path>
                <path
                  fill="#012D3D"
                  d="M295.9,74.4l-2.1-6h-11.5l-2.2,6h-3l9.7-26.5h2.4l9.7,26.5L295.9,74.4z M288.1,52l-5,13.9h9.9L288.1,52z"
                ></path>
                <path
                  fill="#012D3D"
                  d="M313.5,74.4h-10.3V47.9h10c2.3,0,4.2,0.6,5.6,1.9c1.4,1.3,2.2,3,2.2,5.2c0,1.4-0.4,2.6-1.1,3.6
                ...
                <path
                  fill="#012D3D"
                  d="M334.8,74.5c-2,0-3.7-0.3-5.1-0.8c-1.4-0.5-2.7-1.4-4-2.7l1.9-1.9c1.1,1.1,2.1,1.8,3.2,2.2
        ...
        <a href="https://github.com/dreamxinxcode" target="_blank">
          {" "}
          Brandon Lecky
        </a>
        <a href="https://github.com/TimaJuma" target="_blank">
          {" "}
          Tima Juma
        </a>
        <a href="https://github.com/FedorMashoshin" target="_blank">
          {" "}
          Fedor Mashoshin
        </a>
        <a
          href="https://github.com/dreamxinxcode/virtual-vet-clinic"
          target="_blank"
        >
          <svg
